    ...
    <div class="header">
        <div class="logo"><a href="index.html">
            ...
            <div class="logo_text">
                ...
                <a href="/index.html"> </a>
                <h2>
                    <w><a href="/index.html">К</a></w><a href="/index.html">АФЕДРА
                        <w>П</w>РИКЛАДНОЙ
                        <w>М</w>АТЕМАТИКИ</a></h2>
            </div>
            <div class="dante">
                <h1>(3842)
                    <w> 58-37-43</w>
...
@section('left-sidebar')
        ...
        <div class="menu">
            <div class="menu2">
                ...
                <p>
                    <button onclick="parent.location='/sotrudniki'">Сотрудники</button>
                </p>
                <p>
            ...
            <div class="sidebar_container">
                ...
                <div class="sidebar">
                    ...
                    <a href="http://www.math.kemsu.ru">
                        <img src="{{asset('images/math.gif')}}" style="margin-top: 20px;" border="0" height="50" width="200"></a>
                    ...
                    <a href="http://edu.kemsu.ru">
                        <img src="{{asset('images/edu2.gif')}}" style="margin-top: 20px;" border="0" height="50" width="200"></a>
                    ...
                    <a href="http://science.kemsu.ru">
                        <img src="{{asset('images/ban2_150x50.gif')}}" style="margin-top: 20px;" border="0" height="50" width="200"></a>
